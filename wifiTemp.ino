...
//ALMOST MODIFY HERE BEGIN
const PROGMEM char* MQTT_SERVER = "<address to message broker>"; // mqtt server
const PROGMEM char* MQTT_SERVER_PORT = "<port to message broker>"; // mqtt server port
const PROGMEM char* MQTT_SENSOR_TOPIC = "<topic>";
const PROGMEM char* MQTT_CLIENT_ID = "<id of device>";
const PROGMEM char* MQTT_USER = "<message broker user>";
const PROGMEM char* MQTT_PASS = "<message broker pass>";
const char* WIFI_SSID = "<wifi ssid>"; // Nome SSID Wifi
const char* WIFI_PASSWD = "<wifi pass>"; // Password Wifi
int status = WL_IDLE_STATUS;     // the Wifi radio's status
int sent = 1;                   //how many data was sent(count)
//ALMOST MODIFY HERE END
...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  //HERE MODIFY IP ADDRESS AND MASK OF DEVICE AND GATEWAY
